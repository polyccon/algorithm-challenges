...
If prop isn't "tracks" and value isn't empty (""), update or set the value for that
record album's property.
...
If prop is "tracks" and value isn't empty (""), push the value onto the end of the album's
